...
A chart with z-scores on the y-axis to help emphasize deviation from mean rather than concentrating primarily on the number of SQL executed.
...
```js 
    ...
    "title": {
        "text": "Number of SQL detected yesterday compared to the user's historical average",
        "subtitle": "Historical averages shown as red ticks",
