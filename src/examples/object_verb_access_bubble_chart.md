...
Bubble chart similar to the provided GI default, but with modifications to allow for larger bubbles and overlaps as well as a different color scale.
    ...
    "data": {
        "values": [
            ...
            },
            {
                ...
                "DB user": "POLLY",
                "Verb": "SELECT",
                "Sum (Total count)": "1506"
            },
            {
                "Date (Period start (local time))": "2024-08-21",
                "DB user": "DOUGLAS",
                "Verb": "SELECT",
                "Sum (Total count)": "1488"
            },
            {
                "Date (Period start (local time))": "2024-08-21",
                "DB user": "BILL",
            ...
            },
            {
                ...
                "DB user": "RICK",
                "Verb": "SELECT",
                "Sum (Total count)": "1276"
            },
            {
                "Date (Period start (local time))": "2024-08-21",
                "DB user": "MATT",
                "Verb": "SELECT",
                "Sum (Total count)": "1246"
            },
            {
                "Date (Period start (local time))": "2024-08-21",
                "DB user": "DAVID",
                "Verb": "SELECT",
                "Sum (Total count)": "1078"
            },
            {
                "Date (Period start (local time))": "2024-08-21",
                "DB user": "TONY",
                "Verb": "SELECT",
                "Sum (Total count)": "1028"
            },
            {
                "Date (Period start (local time))": "2024-09-03",
                "DB user": "MATT",
