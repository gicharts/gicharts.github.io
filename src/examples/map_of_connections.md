...
A map with manual mappings of client IPs to latitude and longitude connection to a hypothetical data center in Cape Town, South Africa.
...
<div class="tip">In order to make practical use of this example, latitude and longitude mappings in the vega definition below should be replaced.</div>
    ...
    "layer": [
        ...
        },
        {
            ...
            "transform": [
                ...
                {
                    "filter": "indexof(datum['Client IP'], '192.168') == -1"
                },
                {
                    "lookup": "first_3",
                    "from": {
